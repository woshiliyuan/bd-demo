...
public class LogParser {
	...
	//
	// // 样例数据： 27.19.74.143 - - [30/04/2013:17:38:20 +0800] "GET /static/image/common/faq.gif HTTP/1.1" 200 1127
	// // 解析结果： ip=27.19.74.143, time=20130430173820, url=GET /static/image/common/faq.gif HTTP/1.1, status=200, traffic=1127
	// }
}
